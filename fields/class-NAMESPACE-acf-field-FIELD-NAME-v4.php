...
class icomoonpicker_acf_field_icomoon_picker extends acf_field {
	...
	*/
	...
	function __construct( $settings )
	{
		...
		$this->label = __('Icomoon Picker');
		$this->category = __("Basic",'acf-icomoon-picker'); // Basic, Content, Choice, etc
		$this->defaults = array(
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	<td class="label">
		<label><?php _e("Preview Size",'acf-icomoon-picker'); ?></label>
		<p class="description"><?php _e("Thumbnail is advised",'acf-icomoon-picker'); ?></p>
	</td>
	<td>
		<?php
		...
		do_action('acf/create_field', array(
			...
			'layout'	=>	'horizontal',
			'choices'	=>	array(
				'thumbnail' => __('Thumbnail', 'acf-icomoon-picker'),
				'something_else' => __('Something Else', 'acf-icomoon-picker'),
			)
		));
